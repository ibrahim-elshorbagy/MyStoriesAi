  ...
  return (
    <div className="min-h-screen" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-sm border-b border-neutral-200 dark:border-neutral-700 shadow-sm">
        <div className='py-2 border-b border-b-neutral-300 dark:border-b-neutral-700 bg-orange-50 dark:bg-orange-800'>
      ...
      {/* Main Content */}
      <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-orange-50 via-neutral-50 dark:from-orange-900 dark:via-neutral-900 dark:to-orange-800 pt-20">
