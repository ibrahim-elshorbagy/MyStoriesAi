...
export default function SidebarProfileMenu() {
  ...
  return (
    <div className="mt-auto relative" ref={menuRef} >
      <button
        type="button"
        className={`flex w-full min-w-[200px] items-center rounded-xl gap-2 p-2 text-left text-neutral-800 hover:bg-orange-500/5 hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500 dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100 dark:focus-visible:outline-orange-400 ${menuIsOpen ? 'bg-orange-500/10 dark:bg-orange-400/10' : ''}`}
        aria-haspopup="true"
      ...
      >
        {auth.user?.image_url ? (
          ...
          <div className="size-8 rounded-xl bg-orange-500 flex items-center justify-center text-white font-semibold">
        ...
        <i className="fa-solid fa-chevron-right rtl:mr-auto ltr:ml-auto shrink-0 ltr:rotate-90 rtl:rotate-90 ltr:md:rotate-0 rtl:md:rotate-180" aria-hidden="true"></i>
      </button>
      {/* Menu */}
      {menuIsOpen && (
        <div
        ...
        >
          <div className="flex flex-col py-1.5">
            <Link href={route('profile.edit')} className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-neutral-800 underline-offset-2 hover:bg-orange-500/5 hover:text-black focus-visible:underline focus:outline-hidden dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100" role="menuitem">
              <i className="fa-solid fa-user shrink-0" aria-hidden="true"></i>
              <span>{t('profile')}</span>
            </Link>
          </div>
          <div className="flex flex-col py-1.5">
            <ThemeToggle className="w-full justify-start px-2 py-1.5 text-sm font-medium text-neutral-800 underline-offset-2 hover:bg-orange-500/5 hover:text-black focus-visible:underline focus:outline-hidden dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100" />
          </div>
          <div className="flex flex-col py-1.5">
            <LanguageToggle className="w-full justify-start px-2 py-1.5 text-sm font-medium text-neutral-800 underline-offset-2 hover:bg-orange-500/5 hover:text-black focus-visible:underline focus:outline-hidden dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100" />
          </div>
          ...
          <div className="flex flex-col py-1.5">
            <button onClick={HandleLogout} className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-neutral-800 underline-offset-2 hover:bg-orange-500/5 hover:text-black focus-visible:underline focus:outline-hidden dark:text-neutral-300 dark:hover:bg-orange-400/5 dark:hover:text-neutral-100" role="menuitem">
