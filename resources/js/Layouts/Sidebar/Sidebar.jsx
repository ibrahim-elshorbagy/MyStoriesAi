    ...
    >
      ...
      <div className="relative flex w-full max-w-xs flex-col gap-1 text-neutral-800 dark:text-neutral-300">
        ...
        <input
          ...
          className="w-full border border-neutral-300 rounded-xl bg-neutral-100 px-2 py-1.5 pl-9 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500 disabled:cursor-not-allowed disabled:opacity-75 dark:border-neutral-700 dark:bg-neutral-800/50 dark:focus-visible:outline-orange-400"
