...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative overflow-hidden flex items-center bg-gradient-to-br from-orange-50 via-white to-orange-100/50 dark:from-orange-950 dark:via-neutral-900 dark:to-orange-900/70">
      ...
      {/* Floating Decorative Icons - Modern Layout with Responsive Positioning */}
      <div className="absolute inset-0 pointer-events-none z-20">
        {/* Left Side Icons (Around video area) */}
        <div className="absolute top-8 sm:top-16 lg:top-32 left-8 lg:left-4 animate-float opacity-80">
          <i className="fa-solid fa-rocket text-orange-500 text-4xl drop-shadow-lg"></i>
        </div>
        <div className="absolute top-16 sm:top-24 lg:top-48 left-20 lg:left-12 animate-float-delay-1 opacity-70">
          <i className="fa-solid fa-lightbulb text-amber-400 text-2xl drop-shadow-md"></i>
        </div>
        <div className="absolute bottom-8 sm:bottom-16 lg:bottom-32 left-12 lg:left-6 animate-float-delay-2 opacity-75">
          <i className="fa-solid fa-star text-orange-400 text-3xl drop-shadow-lg"></i>
        </div>

        {/* Right Side Icons (Around content area) - Moved away from text on mobile */}
        <div className="absolute top-8 sm:top-12 lg:top-28 right-12 lg:right-20 animate-float-delay-1 opacity-80">
          <i className="fa-solid fa-crown text-orange-600 text-3xl drop-shadow-lg"></i>
        </div>
        <div className="absolute top-16 sm:top-20 lg:top-44 right-24 lg:right-32 animate-float opacity-70">
          <i className="fa-solid fa-gem text-orange-400 text-2xl drop-shadow-md"></i>
        </div>
        <div className="absolute top-20 sm:top-32 lg:top-60 right-8 lg:right-16 animate-float-delay-2 opacity-75">
          <i className="fa-solid fa-magic-wand-sparkles text-amber-500 text-2xl drop-shadow-md"></i>
        </div>

        {/* Bottom Floating Elements - Adjusted for mobile */}
        <div className="absolute bottom-16 sm:bottom-24 lg:bottom-40 left-1/4 animate-float-delay-1 opacity-60">
          <i className="fa-solid fa-fire text-orange-500 text-3xl drop-shadow-lg"></i>
        </div>
        <div className="absolute bottom-8 sm:bottom-16 lg:bottom-32 right-1/4 animate-float opacity-70">
          <i className="fa-solid fa-bolt text-orange-400 text-2xl drop-shadow-md"></i>
        </div>
        <div className="absolute bottom-24 sm:bottom-32 lg:bottom-48 right-1/3 animate-float-delay-2 opacity-65">
          <i className="fa-solid fa-heart text-orange-500 text-2xl drop-shadow-md"></i>
        </div>

        {/* Scattered Center Elements - Hidden on very small screens, visible on sm+ */}
        <div className="absolute top-1/3 left-1/3 animate-float-delay-1 opacity-50 hidden sm:block">
          <i className="fa-solid fa-sparkles text-amber-400 text-xl drop-shadow-sm"></i>
        </div>
        <div className="absolute bottom-1/3 right-2/5 animate-float opacity-55 hidden sm:block">
          <i className="fa-solid fa-certificate text-orange-500 text-xl drop-shadow-sm"></i>
        </div>

        {/* Additional mobile-only icons in safe areas */}
        <div className="absolute top-2 left-2 animate-float opacity-60 sm:hidden">
          <i className="fa-solid fa-sparkles text-orange-400 text-lg drop-shadow-md"></i>
        </div>
        <div className="absolute top-6 right-2 animate-float-delay-1 opacity-50 sm:hidden">
          <i className="fa-solid fa-star text-amber-400 text-sm drop-shadow-sm"></i>
        </div>
        <div className="absolute bottom-2 left-4 animate-float-delay-2 opacity-60 sm:hidden">
          <i className="fa-solid fa-certificate text-orange-500 text-lg drop-shadow-md"></i>
        </div>
        <div className="absolute bottom-6 right-4 animate-float opacity-50 sm:hidden">
          <i className="fa-solid fa-gem text-orange-400 text-sm drop-shadow-sm"></i>
        </div>
      </div>
