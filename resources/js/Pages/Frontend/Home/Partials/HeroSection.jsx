...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative overflow-hidden flex items-center bg-gradient-to-br from-orange-50 via-neutral-50 to-orange-100 dark:from-orange-900 dark:via-neutral-900 dark:to-orange-800 pt-20">
      ...
      {/* Decorative Icons - UPDATED WITH PROPER POSITIONING AND Z-INDEX */}
      <i className="fa-solid fa-star absolute top-24 ltr:left-[5%] rtl:right-[5%] w-8 h-8 text-orange-400 text-3xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-star absolute top-[20%] ltr:left-[13%] rtl:right-[13%] w-7 h-7 text-orange-400 text-2xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-moon absolute top-[25%] ltr:left-[3%] rtl:right-[3%] w-10 h-10 text-orange-500 text-4xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-heart absolute top-[20%] ltr:right-[5%] rtl:left-[5%] w-8 h-8 text-pink-400 text-3xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-cloud absolute bottom-[5%] ltr:right-[2%] rtl:left-[2%] w-20 h-12 text-blue-300 text-5xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-cloud absolute bottom-[1%] ltr:right-[15%] rtl:left-[15%] w-24 h-16 text-blue-300 text-6xl z-20 pointer-events-none"></i>
      <i className="fa-solid fa-cloud absolute bottom-0 ltr:right-[5%] rtl:left-[5%] w-20 h-14 text-blue-300 text-5xl z-20 pointer-events-none"></i>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-16 h-fit lg:h-[480px] xl:h-[540px] 2xl:h-[580px] mx-auto lg:mx-0 py-6 lg:py-0">
        ...
        <div className="flex-[2] lg:py-10 text-center lg:text-start order-1 lg:order-2 gap-4 lg:gap-6 flex flex-col items-center lg:items-start justify-center z-10">
