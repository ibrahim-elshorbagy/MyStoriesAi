  ...
  const contactMethods = [
    {
      ...
      value: 'support@MyStoriesAi.com',
      action: 'mailto:support@MyStoriesAi.com',
      color: 'blue'
    },
    {
      icon: 'fa-phone',
      ...
      <div className="container mx-auto px-3 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
          ...
          <div>
            ...
            {/* FAQ Link  */}
            {/* <div className="mt-8 p-4 sm:p-6 bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-700 rounded-2xl">
          ...
          {[
            ...
            <div key={index} className="text-center">
              <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-xl flex items-center justify-center mx-auto mb-3">
                <i className={`fa-solid ${stat.icon} text-orange-600 dark:text-orange-400`}></i>
              </div>
